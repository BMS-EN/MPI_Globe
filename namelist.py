...
EC_path_20Z = 'MPI_test_20/ECMWF_GLB/%Y%m%d20' #'S:/model/ECMWF_GLB/%Y%m%d20'
NCEP_path_20Z = 'MPI_test_20/NCEP_GLB/%Y%m%d20' #'S:/model/NCEP_GLB/%Y%m%d20'
GRAPES_path_20Z = 'MPI_test_20/GRAPES-GLB/%Y%m%d20' #'S:/model/GRAPES-GLB/%Y%m%d20'
...
output_name_20Z = 'MPI_Globe_%Y%m%d08_' #'S:/mpi_globe/MPI_Globe_%Y%m%d20_'