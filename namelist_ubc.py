...
TS_path   = 'MPI_test_08/TS/' # 

EC_path_08Z = 'MPI_test_08/ECMWF_GLB/%Y%m%d08' # 
NCEP_path_08Z = 'MPI_test_08/NCEP_GLB/%Y%m%d08' # 
GRAPES_path_08Z = 'MPI_test_08/GRAPES-GLB/%Y%m%d08' # 
filename_08Z = '%Y%m%d08.'

EC_path_20Z = 'MPI_test_20/ECMWF_GLB/%Y%m%d20'
NCEP_path_20Z = 'MPI_test_20/NCEP_GLB/%Y%m%d20'
GRAPES_path_20Z = 'MPI_test_20/GRAPES-GLB/%Y%m%d20'
filename_20Z = '%Y%m%d20.'

# Output filename
tag_name = 'MPI_Globe' # the name appears in the micaps file header
output_name_08Z = 'MPI_Globe_%Y%m%d08_' # 
output_name_20Z = 'MPI_Globe_%Y%m%d08_'